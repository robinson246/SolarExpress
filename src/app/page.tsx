  ...
  return (
    <div className='h-full w-full overflow-hidden bg-[#09090b] text-white flex flex-col'>
      ...
      <div className='flex-1 min-h-0 flex flex-row'>
        {/* Left Sidebar */}
        <div className='block w-56 shrink-0 overflow-y-auto overflow-x-hidden border-r border-[rgba(167,139,250,0.1)]'>
          <PlanetMenu
        ...
        {/* Right Panel */}
        <div className='block w-72 shrink-0 overflow-y-auto overflow-x-hidden border-l border-[rgba(167,139,250,0.1)] bg-[#09090b]/50'>
